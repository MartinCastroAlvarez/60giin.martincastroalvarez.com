...
void render(const Shader& shader_light, const Shader& shader_phong, const Shader& shader_depth, const Geometry& quad, const Geometry& cube, const Geometry& pyramid, const Geometry& sphere, const Texture& texture_material, const Texture& texture_reflection, const Texture& texture_normal, float time) {
  ...
  // ---------------------------------------
  {
    ...
    shader_phong.set("dirLight.direction", glm::vec3(view * glm::vec4(lightDirWorld, 0.0f)));
    ...
    // Sun (Point Light 2)
    shader_phong.set("pointLight2.position", glm::vec3(view * glm::vec4(sunPosition, 1.0f)));
