...
void main() {
	...
	vec3 phong = calcDirectionalLight(dirLight, norm, viewDir, albedo_map, specular_map, shadow, shadowIntensity, material.shininess);
	...
	phong += calcSpotLight(spotLight2, norm, viewDir, fragPos, albedo_map, specular_map, material.shininess);
