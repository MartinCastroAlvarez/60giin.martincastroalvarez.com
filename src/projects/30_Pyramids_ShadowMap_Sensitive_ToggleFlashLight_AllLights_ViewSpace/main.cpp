...
void render(const Shader& shader_light, const Shader& shader_phong, const Shader& shader_depth, const Geometry& quad, const Geometry& cube, const Geometry& pyramid, const Geometry& sphere, const Texture& texture_material, const Texture& texture_reflection, uint32_t fbo, uint32_t text_fbo) {
...
int main(int argc, char* argv[]) {
  ...
  while (window->isAlive()) {
    ...
    //update();
    render(shader_light, shader_phong, shader_depth, quad, cube, pyramid, sphere, texture_material, texture_reflection, fbo.first, fbo.second);
